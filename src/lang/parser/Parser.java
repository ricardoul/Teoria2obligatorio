...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Jul 10 18:43:31 UYT 2017
  */
public class Parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    ...
    "\002\000\006\002\uffff\005\007\001\002\000\026\002\ufff5" +
    "\006\ufff5\007\ufff5\010\ufff5\011\ufff5\012\ufff5\013\ufff5\014" +
    "\ufff5\015\ufff5\016\ufff5\001\002\000\004\005\007\001\002" +
    "\000\024\002\001\007\015\010\017\011\013\012\016\013" +
    "\014\014\020\015\012\016\011\001\002\000\026\002\ufff7" +
    "\006\ufff7\007\ufff7\010\ufff7\011\ufff7\012\ufff7\013\ufff7\014" +
    "\ufff7\015\ufff7\016\ufff7\001\002\000\004\016\025\001\002" +
    "\000\004\005\007\001\002\000\026\002\ufff9\006\ufff9\007" +
    "\ufff9\010\ufff9\011\ufff9\012\ufff9\013\ufff9\014\ufff9\015\ufff9" +
    "\016\ufff9\001\002\000\004\005\007\001\002\000\004\005" +
    "\007\001\002\000\004\005\007\001\002\000\026\002\ufff8" +
    "\006\ufff8\007\ufff8\010\ufff8\011\ufff8\012\ufff8\013\ufff8\014" +
    "\ufff8\015\ufff8\016\ufff8\001\002\000\026\002\ufffc\006\ufffc" +
    "\007\ufffc\010\ufffc\011\ufffc\012\ufffc\013\014\014\020\015" +
    "\012\016\ufffc\001\002\000\026\002\ufffa\006\ufffa\007\ufffa" +
    "\010\ufffa\011\ufffa\012\ufffa\013\014\014\020\015\012\016" +
    "\ufffa\001\002\000\026\002\ufffd\006\ufffd\007\ufffd\010\ufffd" +
    "\011\ufffd\012\ufffd\013\014\014\020\015\012\016\ufffd\001" +
    "\002\000\026\002\ufffb\006\ufffb\007\ufffb\010\ufffb\011\ufffb" +
    "\012\ufffb\013\014\014\020\015\012\016\ufffb\001\002\000" +
    "\026\002\ufff6\006\ufff6\007\ufff6\010\ufff6\011\ufff6\012\ufff6" +
    "\013\ufff6\014\ufff6\015\ufff6\016\ufff6\001\002\000\024\006" +
    "\027\007\015\010\017\011\013\012\016\013\014\014\020" +
    "\015\012\016\011\001\002\000\026\002\ufffe\006\ufffe\007" +
    "\ufffe\010\ufffe\011\ufffe\012\ufffe\013\ufffe\014\ufffe\015\ufffe" +
  ...
  protected static final short[][] _reduce_table = 
    ...
    "\006\003\005\004\007\001\001\000\002\001\001\000\006" +
    "\003\005\004\025\001\001\000\002\001\001\000\002\001" +
    "\001\000\002\001\001\000\006\003\005\004\023\001\001" +
    "\000\002\001\001\000\006\003\005\004\022\001\001\000" +
    "\006\003\005\004\021\001\001\000\006\003\005\004\020" +
      ...
      switch (CUP$Parser$act_num)
		...
		QObject qo = (QObject)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new Expression(); RESULT.addQobjects(qo); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 11: // expression ::= expression TILDE IDS 
            {
              Expression RESULT =null;
		...
		String s = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new Expression(); RESULT.searchRegex(e, s); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 10: // expression ::= expression IDS 
            {
              Expression RESULT =null;
		...
		String s = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new Expression(); RESULT.searchTag(e, s); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 9: // expression ::= expression DOT 
            {
              Expression RESULT =null;
		int eleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)).left;
		int eright = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)).right;
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = new Expression(); RESULT.dot(e); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 8: // expression ::= expression SLASH 
            {
              Expression RESULT =null;
		int eleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)).left;
		int eright = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)).right;
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = new Expression(); RESULT.slash(e); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 7: // expression ::= expression INTERSECT expression 
            {
              Expression RESULT =null;
		...
		Expression e2 = (Expression)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new Expression(); RESULT.intersect(e1,e2); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 6: // expression ::= expression DIFFERENCE expression 
            {
              Expression RESULT =null;
		int e1left = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).left;
		int e1right = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).right;
		...
		Expression e2 = (Expression)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new Expression(); RESULT.difference(e1,e2); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 5: // expression ::= expression UNION expression 
            {
              Expression RESULT =null;
		int e1left = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).left;
		int e1right = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).right;
		...
		Expression e2 = (Expression)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new Expression(); RESULT.union(e1,e2); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // expression ::= expression CONCAT expression 
            {
              Expression RESULT =null;
		int e1left = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).left;
		int e1right = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).right;
		...
		Expression e2 = (Expression)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new Expression(); RESULT.concat(e1,e2); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 3: // expression ::= L_BRACKET expression R_BRACKET 
            {
              Expression RESULT =null;
		int eleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)).left;
		int eright = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)).right;
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 ...
		 RESULT = new Expression(Singleton.getData(), null); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("QQuery",0, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 1: // $START ::= QQuery EOF 
            {
              Object RESULT =null;
		...
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = e; 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("QQuery",0, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
